...
{{-- ================================================================== --}}
{{-- 🎨 ULTIMATE PREMIUM INTERACTIVE STYLESHEET - النسخة النهائية المدمجة --}}
{{-- ================================================================== --}}
...
<style>
    ...
    * {
    ...
    .hero-spotted-container {
        ...
        background-image: 
            radial-gradient(rgba(249, 115, 22, 0.08) 1.5px, transparent 1.5px),
    ...
    .filter-bar:focus-within {
        ...
        box-shadow: var(--shadow-lg), 0 0 0 3px rgba(249, 115, 22, 0.1);
    }
...
<div class="max-w-screen-xl mx-auto px-6 pt-10">
    ...
    <div class="hero-spotted-container bg-white flex flex-col md:flex-row items-center p-8 md:p-16 gap-12 3d-card-wrapper">
        <div class="md:w-1/2 relative flex justify-center">
            <div class="absolute top-0 left-0 w-40 h-40 bg-orange-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-pulse"></div>
        ...
        <div class="md:w-1/2 text-right space-y-6">
            <span class="text-xs font-bold tracking-widest text-orange-500 bg-orange-50 px-4 py-2 rounded-full inline-block">✨ New Collection 2026</span>
            ...
            <div class="pt-4">
                <a href="#products" class="inline-block bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white font-bold px-10 py-4 rounded-2xl shadow-lg shadow-orange-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 py-24">
        <div class="feature-card scroll-reveal">
            <div class="feature-icon bg-emerald-50 text-emerald-500">🍼</div>
            <h3 class="font-bold text-gray-800 text-xl mb-3">عناية بالمنتج</h3>
            <p class="text-gray-400 text-sm leading-relaxed">ملابس خاصة صنعت بعناية فائقة لحديثي الولادة بمواد قطنية 100% آمنة وناعمة.</p>
        </div>
        <div class="feature-card scroll-reveal">
            <div class="feature-icon bg-rose-50 text-rose-500">🧷</div>
            <h3 class="font-bold text-gray-800 text-xl mb-3">خبرتنا الطويلة</h3>
            <p class="text-gray-400 text-sm leading-relaxed">صنعت كل قطعة بحب وشغف لتناسب طفلك وتواكب الموضة العالمية الحديثة.</p>
        </div>
        <div class="feature-card scroll-reveal">
            <div class="feature-icon bg-amber-50 text-amber-500">🎁</div>
            <h3 class="font-bold text-gray-800 text-xl mb-3">مفاجآت وهدايا</h3>
                ...
                @foreach($stories as $story)
                    <div class="swiper-slide !w-auto">
                        <div class="flex flex-col items-center gap-3 cursor-pointer group" onclick="openVideoModal('{{ $story['video'] }}')">
                            <div class="w-24 h-24 rounded-full p-1 bg-gradient-to-tr from-orange-500 via-pink-500 to-rose-500 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg shadow-md">
                            ...
                            <span class="text-xs font-bold text-gray-700 group-hover:text-orange-500 transition-colors">{{ $story['name'] }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-screen-xl mx-auto px-6">
        <div class="grid md:grid-cols-2 gap-8 category-grid">
            <div class="category-card scroll-reveal" style="--bg-image: url('https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?q=80&w=1972&auto=format&fit=crop'); --mouse-x: 50%; --mouse-y: 50%;">
            ...
            <div class="category-card scroll-reveal" style="--bg-image: url('https://images.unsplash.com/photo-1518833278463-d3055863572f?q=80&w=2070&auto=format&fit=crop'); --mouse-x: 50%; --mouse-y: 50%;">
                <div class="card-glow"></div>
                <div class="card-content">
    ...
    <div class="max-w-screen-xl mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div class="text-right">
                <h2 class="text-4xl md:text-5xl font-black text-gray-900">الأكثر <span class="text-orange-500">مبيعاً</span></h2>
                ...
                <div class="product-card-ty scroll-reveal magnetic-card">
                    <div class="ty-image-wrapper">
                        ...
                        <div class="ty-glass-overlay">
                            <button type="button" onclick="openSizeModal({{ $product->id }}, {{ json_encode($product->sizes ?? []) }})" class="w-full bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm shadow-lg transform hover:scale-105">
                                <span>🛒</span>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="luxury-image group cursor-pointer overflow-hidden shadow-2xl">
                ...
                <div class="absolute bottom-8 right-8 text-right text-white max-w-sm space-y-2">
                    <span class="bg-orange-500 px-4 py-2 rounded-full text-xs font-bold">✨ إطلالة العيد</span>
                    <h3 class="text-2xl font-black leading-tight">أناقة الأطفال تبدأ من اختيار القطع الصحيحة</h3>
                </div>
            </div>

            <div class="space-y-8 text-right">
                <span class="inline-block py-2 px-5 bg-orange-50 text-orange-600 rounded-full text-xs font-bold">🎯 ستايل مختار لك</span>
                ...
                <div class="space-y-4">
                    <div class="flex flex-row-reverse items-center p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-md hover:shadow-lg hover:border-orange-200 transition-all duration-300 cursor-pointer group">
                        ...
                        <div class="mr-5 flex-1 text-right">
                            ...
                            <p class="text-orange-500 font-bold text-sm mt-1">250 ₺</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row-reverse items-center p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-md hover:shadow-lg hover:border-orange-200 transition-all duration-300 cursor-pointer group">
                        ...
                        <div class="mr-5 flex-1 text-right">
                            ...
                            <p class="text-orange-500 font-bold text-sm mt-1">170 ₺</p>
                        </div>
                    </div>

                    <button class="w-full py-4 bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white rounded-xl font-bold text-base shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            ...
            <div class="reviews-track flex">
                @for ($i = 0; $i < 3; $i++ )
                    <div class="review-card">
                        <img src="https://ui-avatars.com/api/?name=سارة+أحمد&background=FFE4E6&color=F97316&size=128" class="review-img">
                    ...
                    <div class="review-card">
                        <img src="https://ui-avatars.com/api/?name=محمد+علي&background=FFE4E6&color=F97316&size=128" class="review-img">
...
<div class="floating-contact-buttons">
    <button class="contact-button whatsapp-button" title="تواصل عبر WhatsApp" onclick="window.open('https://wa.me/1234567890', '_blank')">
        <i class="fab fa-whatsapp"></i>
    </button>
    <button class="contact-button livechat-button" title="دردشة مباشرة">
...
<div id="sizeModal" class="fixed inset-0 bg-black/50 z-[200] hidden flex items-center justify-center p-6 backdrop-blur-sm">
    <div class="bg-white rounded-3xl p-8 max-w-md w-full text-right shadow-2xl">
        ...
        <div class="flex gap-4">
            <button onclick="confirmAddToCart()" class="flex-1 bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white py-3 rounded-xl font-bold transition-all transform hover:scale-105">تأكيد</button>
...
<script>
    ...
    function openSizeModal(productId, sizes) {
        ...
        sizes.forEach(size => {
            ...
            btn.innerText = size;
            btn.className = "border-2 border-gray-200 px-5 py-2 rounded-xl font-semibold text-sm hover:border-orange-500 hover:bg-orange-50 transition";
            btn.onclick = () => {
                selectedSize = size;
    ...
    function showToast(message) {
        ...
        toast.className = "fixed bottom-24 right-5 bg-gray-900 text-white text-sm font-bold px-6 py-4 rounded-xl z-[1000] shadow-2xl text-right animate-pulse";
