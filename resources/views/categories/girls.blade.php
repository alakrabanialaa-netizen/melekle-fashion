...
<main class="bg-[#fdfdfd] min-h-screen">
    ...
    <div class="container mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <p class="text-gray-500 text-lg">أحدث التصاميم لصغيرتك الأنيقة</p>
    </div>
    ...
    <div class="container mx-auto px-4 pb-24">
        ...
        @else
            ...
            <div class="text-center py-32 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                ...
                <p class="text-gray-500 mb-8">نحن نجهز تشكيلة بناتية مذهلة، انتظرونا!</p>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-6 text-xl">
                        <a href="https://www.instagram.com/meleklerkids/" target="_blank" class="hover:text-pink-500 transition"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.facebook.com/MELEKLERKIDSTR" target="_blank" class="hover:text-pink-500 transition"><i class="fab fa-facebook"></i></a>
                        <a href="https://api.whatsapp.com/message/CL67ADRC7PMFO1" target="_blank" class="hover:text-pink-500 transition"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
