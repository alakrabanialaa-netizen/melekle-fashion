...
<main class="bg-[#fdfdfd] min-h-screen">
    ...
    <div class="container mx-auto px-4 pt-16 pb-12 text-center">
        <h1 class="text-4xl md:text-5xl font-black text-gray-900 mb-3 animate-fade-in">قسم البنات</h1>
        <div class="w-20 h-1 bg-pink-500 mx-auto mb-4 rounded-full"></div>
        <p class="text-gray-500 text-lg">أجمل التصاميم والألوان لأميرتك الصغيرة</p>
    </div>
    ...
    <div class="container mx-auto px-4 pb-24">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-8">
                @foreach($products as $product)
                    <div class="product-card-ty group relative flex flex-col justify-between">
                        ...
                        {{-- 🔗 تصحيح رابط المنتج ليشمل الـ ID والـ Slug --}}
                        <a href="{{ route('products.show', [$product->id, $product->product_slug ?? 'girl-style']) }}" class="ty-image-wrapper block relative overflow-hidden rounded-t-xl">
                        ...
                        <div class="ty-info-wrapper flex flex-col justify-between p-4 flex-grow text-right">
                            <a href="{{ route('products.show', [$product->id, $product->product_slug ?? 'girl-style']) }}">
        ...
        @else
            ...
            <div class="text-center py-32 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                ...
                <p class="text-gray-500 mb-8">نحن نجهز تشكيلة بناتي مميزة، انتظرونا!</p>
                <a href="{{ url('/') }}" class="inline-block px-10 py-3 bg-gray-900 text-white font-bold rounded-full hover:bg-pink-500 transition-all">
                    العودة للرئيسية
                </a>
            </div>
        @endif
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                <div>
                    ...
                    <div class="flex gap-4 mt-6 text-xl">
                        <a href="https://www.instagram.com/meleklerkids/" target="_blank" rel="noopener noreferrer" class="hover:text-pink-500 transition"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.facebook.com/MELEKLERKIDSTR" target="_blank" rel="noopener noreferrer" class="hover:text-pink-500 transition"><i class="fab fa-facebook"></i></a>
                        <a href="https://api.whatsapp.com/message/CL67ADRC7PMFO1" target="_blank" rel="noopener noreferrer" class="hover:text-pink-500 transition"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <button class="px-5 bg-pink-500 text-white rounded-l-xl hover:bg-pink-600 transition font-bold text-sm">اشتراك</button>
                    </div>
                </div>
            </div>
