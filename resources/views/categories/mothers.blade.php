                        ...
                        <div class="ty-info-wrapper">
                            ...
                            <div class="flex items-center justify-between mt-auto">
                                ...
                                <form action="{{ url('cart-add/'.$product->id) }}" method="POST" class="md:hidden">
                                    @csrf
                                    <button type="submit" class="w-10 h-10 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all">
