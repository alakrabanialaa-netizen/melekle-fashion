...
<main class="bg-[#fdfdfd] min-h-screen">
    ...
    <div class="container mx-auto px-4 pt-16 pb-12 text-center">
        <h1 class="text-4xl md:text-5xl font-black text-gray-900 mb-3 animate-fade-in">قسم الأمهات والعروض التركية</h1>
        <div class="w-20 h-1 bg-orange-500 mx-auto mb-4 rounded-full"></div>
        <p class="text-gray-500 text-lg">أقوى التخفيضات الحصرية والتصاميم الراقية واصلة مستودع الشام</p>
    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-8">
                @foreach($products as $product)
                    <div class="product-card-ty group relative flex flex-col justify-between">
                        ...
                        <a href="{{ route('products.show', [$product->id, $product->product_slug ?? 'mother-style']) }}" class="ty-image-wrapper block relative overflow-hidden rounded-t-xl">
                        ...
                        <div class="ty-info-wrapper flex flex-col justify-between p-4 flex-grow text-right">
                            <a href="{{ route('products.show', [$product->id, $product->product_slug ?? 'mother-style']) }}">
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                <div>
                    ...
                    <div class="flex gap-4 mt-6 text-xl">
                        ...
                        <a href="https://api.whatsapp.com/message/CL67ADRC7PMFO1" target="_blank" rel="noopener noreferrer" class="hover:text-orange-500 transition"><i class="fab fa-whatsapp"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <button class="px-5 bg-orange-500 text-white rounded-l-xl hover:bg-orange-600 transition font-bold text-sm">اشتراك</button>
                    </div>
                </div>
            </div>
